...
public class BattleGui {
  ...
  public void setOuterSector(int sectorNum, int allyNum, int enemyNum) {
    this.outerSectors[sectorNum * 2].setText(NumberFormat.getNumberInstance(Locale.US).format(
        allyNum));
    this.outerSectors[(sectorNum * 2) + 1].setText(NumberFormat.getNumberInstance(Locale.US)
        .format(enemyNum));
  }

  public void setInnerSector(int sectorNum, int allyNum, int enemyNum) {
    this.innerSectors[sectorNum * 2].setText(NumberFormat.getNumberInstance(Locale.US).format(
        allyNum));
    this.innerSectors[(sectorNum * 2) + 1].setText(NumberFormat.getNumberInstance(Locale.US)
        .format(enemyNum));
  }
